...
#定义测试类，继承unittest框架
from interfaceframework.HTMLTestRunner import HTMLTestRunner
...
if __name__ == '__main__':
    ...
    filename=p2+"\\testresultfile\ind_result\\test_updateuser_report.html"
    file2=open(filename,"wb")
    #调用HTMLTestRunner
    runner=HTMLTestRunner(stream=file2,title="更新用户信息接口测试",description="接口自动化测试")
    runner.run(suite)
